...
function Meta({ track: t, size }: { track: Track; size: "sm" | "md" }) {
  return (
    <div className="min-w-0 flex-1">
      ...
      <div className="truncate text-white/70" style={{ fontSize: 12.5 }}>
...
export function RadioPlayer() {
  ...
  return (
    <div className="flex w-full max-w-xl flex-col gap-3">
      ...
      <div className={`overflow-hidden rounded-[22px] ${GLASS} p-1.5`}>
